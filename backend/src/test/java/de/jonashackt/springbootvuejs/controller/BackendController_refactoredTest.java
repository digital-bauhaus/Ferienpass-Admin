...
import de.jonashackt.springbootvuejs.repository.TeilnehmerRepository_refactoredTest;
...
public class BackendController_refactoredTest {
    ...
    public void addNewUserAndRetrieveItBack() {
        Teilnehmer user = TeilnehmerRepository_refactoredTest.createUser();
    ...
    public void addNewProjectAndetrieveItBack() {
        Projekt p = TeilnehmerRepository_refactoredTest.createSingleProject();
        Long projectID =
                given()
                .body(p)
                .contentType(ContentType.JSON)
